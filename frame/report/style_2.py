...
<head>
    ...
    <style type="text/css">
        ...
        .user-activity-list .user-element {
            border-bottom: 1px solid #e7eaec
        }

        .user-element:first-child {
            margin-top: 0
        }
        ...
        .user-element, .user-element .media {
            margin-top: 15px
        }

        .user-element, .media-body {
            overflow: hidden
        }
        ...
        .user-element > .pull-left {
            margin-right: 10px
        }

        .user-element img.img-circle, .dropdown-messages-box img.img-circle {
            width: 38px;
            height: 38px
        }
        ...
        .user li.left .user-body {
            margin-left: 60px
        }

        .user li.right .user-body {
            margin-right: 60px
        }
        ...
        .user .glyphicon, .panel .slidedown .glyphicon {
            margin-right: 5px
        }
        ...
        .user-discussion .user-message:nth-child(2n+1) .message-avatar {
            float: left;
            margin-right: 10px
        }

        .user-discussion .user-message:nth-child(2n) .message-avatar {
            float: right;
            margin-left: 10px
        }
        ...
        .user-discussion .user-message:nth-child(2n+1) .message-date {
            float: right
        }

        .user-discussion .user-message:nth-child(2n) .message-date {
            float: left
        }

        .user-discussion .user-message:nth-child(2n+1) .message {
            text-align: left;
            margin-left: 55px
        }

        .user-discussion .user-message:nth-child(2n) .message {
            text-align: right;
            margin-right: 55px
        }
        ...
        .small-user-box.ng-small-user {
            display: block
        }

        .body-small .small-user-box {
            bottom: 70px;
            right: 20px
        }

        .small-user-box.active {
            display: block
        }

        .small-user-box .heading {
            background: #2f4050;
            padding: 8px 15px;
            font-weight: 700;
            color: #fff
        ...
        .small-user-box .user-date {
            opacity: .6;
            font-size: 10px;
            font-weight: 400
        }

        .small-user-box .content {
            padding: 15px
        }

        .small-user-box .content .author-name {
            font-weight: 700;
            margin-bottom: 3px;
            font-size: 11px
        }

        .small-user-box .content > div {
            padding-bottom: 20px
        }

        .small-user-box .content .user-message {
            padding: 5px 10px;
            border-radius: 6px;
            font-size: 11px;
            line-height: 14px;
        ...
        .small-user-box .content .user-message.active {
            background: #1ab394;
            color: #fff
        }

        .small-user-box .content .left {
            text-align: left;
            clear: both
        }

        .small-user-box .content .left .user-message {
            float: left
        }

        .small-user-box .content .right {
            text-align: right;
            clear: both
        }

        .small-user-box .content .right .user-message {
            float: right
        }

        .small-user-box .form-user {
            padding: 10px
        }
        ...
        body.rtls .user-statistic, body.rtls .user-users {
            margin-right: -30px;
            margin-left: auto
        }
...
<script type="text/javascript">
    ...
    if ($(".tooltip-test_module").tooltip({
